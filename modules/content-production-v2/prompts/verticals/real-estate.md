## VERTICAL RULES — REAL ESTATE (mandatory)

These rules apply to all real-estate content: articles, neighborhood guides, FAQs, fit sections, taglines. They were derived from a 5-pass manual factual review and prevent errors that required correction on flagship guides.
...
### 3. SAFETY — NO NAMED "SAFER" NEIGHBORHOODS
...
### 4. METHODOLOGY DISCLAIMER (for ranked guides)
Every guide with a 1-N ranking must include: "The final ranking is an editorial assessment informed by these factors rather than a purely mathematical calculation." Plus a data note citing sources and verification dates where practical.

### 5. GEOGRAPHIC ACCURACY
Verify place facts — which lake, highway, boundary. Do NOT assign a neighborhood to the wrong geographic feature. Header stats (qstats count, district count) must match body claims and FAQ answers. If the header says "4 ISDs," every mention in the guide must agree.

### 6. PROPERTY-TYPE NOTE
