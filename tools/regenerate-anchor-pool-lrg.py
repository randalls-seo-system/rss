...
SYSTEM_PROMPT = """You are generating short, distinctive anchor text phrases for an internal-linking system on a Texas real estate brokerage website covering neighborhoods, home buying, military relocation, and property topics across San Antonio, Austin, Killeen, and surrounding Central Texas cities.
...
For each destination URL below, produce TWO anchor phrases:
  ...
  - secondary_anchor: a slightly more general 2-3 word alternative that a writer would naturally use in a sentence about related topics

STRICT RULES:
1. EXCLUDE generic filler words. Never include in any phrase: "real estate", "home buying guide", "complete guide", "everything you need", "learn more". The phrase must identify the SPECIFIC topic, not the content format.
2. Both anchor phrases MUST be 2-3 words. No 1-word phrases. No 4+ word phrases. No filler words like "the", "a", "your".
3. Both anchor phrases MUST be noun phrases that would appear naturally in body prose. Good: "property taxes", "BAH rates", "Austin neighborhoods". Bad: "explore Austin", "understanding taxes", "learn about BAH".
...
6. City/area names are GOOD anchors when paired with a topic word. Examples: "Round Rock neighborhoods", "Killeen schools", "Gruene homes", "San Antonio BAH".

Also assign each destination a topic_cluster from this fixed list:
  neighborhoods, military, cost, schools, taxes, buying, selling, lending, comparison, lifestyle, general
